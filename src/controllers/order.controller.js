...
export const postOrder = async ( req, res ) => {
    try {
        ...
        if(carrito){
            logger.info("Se encontro carrito para comprar");
            ...
            await sendWhatsAppAdmin(orderEnviar, total, user);
            await sendWhatsApp(orderEnviar, total , user);
            await sendEmailNewOrder(orderEnviar, total, user);
